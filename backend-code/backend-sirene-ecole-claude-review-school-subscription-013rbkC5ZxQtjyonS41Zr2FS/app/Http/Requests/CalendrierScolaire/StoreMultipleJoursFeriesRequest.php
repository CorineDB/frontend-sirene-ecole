...
/**
 * @OA\Schema(
 *     schema="StoreMultipleJoursFeriesRequest",
 *     title="Store Multiple Public Holidays Request",
 *     description="Request body for creating or updating multiple public holiday entries for a school calendar",
 *     type="array",
 *     @OA\Items(
 *         @OA\Property(
 *             property="id",
 ...
 *             format="uuid",
 *             nullable=true,
 *             description="ID of the public holiday (for updates)"
 *         ),
 *         @OA\Property(
 ...
 * )
 */
class StoreMultipleJoursFeriesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            '*.id' => ['nullable', 'string', 'exists:jours_feries,id'],
